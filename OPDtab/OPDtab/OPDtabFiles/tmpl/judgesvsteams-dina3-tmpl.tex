...
\newcolumntype{Z}{@{\hspace{2pt}}>{\raggedright\arraybackslash}p{0.034\linewidth}@{\hspace{2pt}}}
...
%    \node[fill=\myColTwo, draw, text width=0.9em, align=center] at (0.38,0) {\numToText{#2}};
%    \node[fill=\myColThree, draw, text width=0.9em, align=center] at (0.76,0) {\numToText{#3}};
%  \end{tikzpicture}
...
\begin{document}
<!-BEGIN:PAGES->
\begin{tabularx}{\linewidth}{Y|ZZZ|ZZZ|ZZZ|ZZZ|ZZZ|ZZZ|ZZZ|ZZZ|}
  \multicolumn{1}{c}{}
  <!-BEGIN:ROOMS->
